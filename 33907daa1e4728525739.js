...
function handleSignIn() {
  return new Promise(function (resolve, reject) {
    ...
    generateCodeChallenge(codeVerifier).then(function (codeChallenge) {
      ...
      var startUrl = new URL('https://eventellect.github.io/outlook-email-saving/sign-in-start.html');
              ...
              return _regeneratorRuntime().wrap(function _callee7$(_context7) {
                while (1) switch (_context7.prev = _context7.next) {
                  ...
                  case 17:
                    ...
                    Office.context.ui.displayDialogAsync("https://eventellect.github.io/outlook-email-saving/retry-dialog.html?error=".concat(errorMessage), {
                      height: 30,
                      width: 20,
                      displayInIframe: true
